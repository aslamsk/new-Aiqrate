...
const TalentMappingStrategiesGCC = () => {
    return (
      <Layout>
        ...
        <Container>
          ...
          <Row>
            ...
            <Col lg={6}>
              <p className="normal-para mt-2">
                AI talent acquisition and management is lagging the fast-paced nature of AI adoption. GCCs are
            ...
            <p className="normal-para">
              The AIQRATE Pinnacle Framework creates a structure to define the GCC’s AI centric job roles and the
          ...
          <p>The AIQRATE Pinnacle Framework includes:</p>
          <Row>
            <ul>
...
export default TalentMappingStrategiesGCC;
