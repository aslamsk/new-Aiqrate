...
const MasterclassEnterprises = () => {
          ...
          <Row>
            ...
            <Col lg={6}>
              <p className="normal-para mt-2">
                The AI Masterclass for Enterprises will compel CXOs, Senior leaders and decision makers to cogitate
                towards developing AI strategies in conjunction with developing frameworks and action plans for
                leveraging AI capabilities to inculcate Transformation, Innovation and Disruption dynamics. They will
                also be showcased with topical scenarios, industry specific applications, best practices and global
                trends in the AI arena.
              </p>
            </Col>
            <p className="normal-para">
              The AI Masterclass will allow you to know your business’ readiness towards adopting AI and/or develop a
  ...
  export default MasterclassEnterprises;
